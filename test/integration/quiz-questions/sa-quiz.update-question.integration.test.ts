...
} from '../../../src/modules/quiz/questions/application/usecases/update-question.usecase';
...
describe('SA Quiz - UpdateQuestion (integration)', () => {
  ...
  it('should be update question. Check question to View', async () => {
    ...
    expect(updatedQuestion.body).toBe(changePayload.body);
    expect(updatedQuestion.correctAnswers).toEqual(changePayload.answers);
  });
});
